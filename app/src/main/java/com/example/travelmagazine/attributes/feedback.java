...
public class feedback {
    ...
    public feedback(String id_user, String id_excursion, String text, double estimation,
                    String datatime, String photo, double cost, String photoReview) {
    ...
    public String getPhotoReview() { return photoReview; }
    public void setPhotoReview(String photoReview) { this.photoReview = photoReview; }
}